    ...
    if ( ! class_exists( 'wp_Theme_Options' ) ) {
        ...
        class wp_Theme_Options {
            ...
            public function setSections() {
                // $this->sections[] = array(
                //     'title'  => __( 'Calendar', 'wp' ),
                //     'desc'   => __( 'Setings for Calendar on this theme.', 'wp' ),
                //     'icon'   => 'el el-cog',
                //     'fields' => array(
                //         array(
                //             'id'             => 'url_calendar',
                ...
                $this->sections[] = array(
                    'title'  => __( 'Header', 'wp' ),
                    'desc'   => __( 'Setings for Header on this theme.', 'wp' ),
                    'icon'   => 'el el-cog',
                    'fields' => array(
                        array(
                            'id'             => 'download-id',
                ...
                $this->sections[] = array(
                    'title'  => __( 'Footer', 'wp' ),
                    'desc'   => __( 'Setings for Footer on this theme.', 'wp' ),
                    'icon'   => 'el el-cog',
                    'fields' => array(
                        array(
                            'id'             => 'contact-title',
